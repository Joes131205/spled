...
function RouteComponent() {
    ...
    return (
      ...
      `}</style>
            ...
            <div
                className="blob-a fixed top-[-80px] left-[-80px] w-[400px] h-[400px] rounded-full opacity-20 blur-3xl pointer-events-none"
                style={{
                    background: "radial-gradient(circle, #7c3aed, transparent)",
                }}
            />
            <div
                className="blob-b fixed bottom-[-100px] right-[-60px] w-[450px] h-[450px] rounded-full opacity-15 blur-3xl pointer-events-none"
                style={{
            ...
            <nav
                className="relative z-50 border-b border-white/10 backdrop-blur-md px-6 py-4"
            ...
            <div className="relative z-10 max-w-2xl mx-auto px-6 py-10 fade-up">
                ...
                {loading ? (
                    ...
                    >
                        <div
                            className="px-8 py-8 border-b border-white/10 flex flex-col items-center gap-4"
                            style={{ background: "rgba(255,255,255,0.02)" }}
                        >
                            <div className="relative">
                                <div
                                    className="w-24 h-24 rounded-full overflow-hidden border-2 border-white/20 flex items-center justify-center text-white text-2xl font-bold"
                                    style={{
                        ...
                        <div className="px-8 py-8 space-y-5">
                            {message.text && (
                                <div
                                    className={`p-3 rounded-xl text-sm border ${message.type === "success" ? "bg-green-500/10 border-green-500/30 text-green-400" : "bg-red-500/10 border-red-500/30 text-red-400"}`}
                                >
                                    {message.text}
                                </div>
                            )}
                            ...
                            <div>
                                ...
                                <div
                                    className="w-full px-4 py-3 rounded-xl border border-white/5 text-gray-500 text-sm"
                                    style={{
