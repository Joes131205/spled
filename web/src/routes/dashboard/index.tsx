        ...
        <div className="grid gap-8 py-4">
            ...
            <div className="flex flex-col gap-2">
                <div className="space-y-1">
                    <p className="text-xs font-bold tracking-[0.24em] uppercase text-indigo-700">Workspace</p>
                    <h1 className="page-title text-6xl -ml-1">Projects</h1>
                </div>
                ...
                <div className="project-grid">
                    {projects.map((project) => (
                        ...
                        >
                            ...
                            {/* Role (no second leave button here) */}
