      ...
      <div className="w-full max-w-md relative z-10 py-10">
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" className="text-cyan-400" style={{color:'#06b6d4'}}>
                ...
                <path d="M8 17h2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
            </svg>
          </div>
            <p className="text-gray-400 text-sm">Assign a task to your team member.</p>
        </div>
        ...
        <div className="rounded-3xl p-8 border border-white/10 backdrop-blur-md"
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-3">Task Weight</label>
              <div className="grid grid-cols-3 gap-3">
                {[
                  { value: 'easy', label: 'Easy', desc: '1 point', color: '#10b981' },
                  { value: 'medium', label: 'Medium', desc: '2 points', color: '#f59e0b' },
                  { value: 'hard', label: 'Hard', desc: '3 points', color: '#ef4444' },
                ].map((w) => (
                  <div
                    key={w.value}
                    ...
                    style={{
                      borderColor: weight === w.value ? w.color : 'rgba(255,255,255,0.1)',
                      background: weight === w.value ? `${w.color}15` : 'rgba(255,255,255,0.03)',
                    }}>
                    <div className="flex justify-center mb-2"
                      style={{ color: weight === w.value ? w.color : '#6b7280' }}>
                      <WeightIcon type={w.value} />
                    </div>
                    <p className="text-sm font-semibold"
                      style={{ color: weight === w.value ? w.color : '#9ca3af' }}>
                      {w.label}
                    </p>
