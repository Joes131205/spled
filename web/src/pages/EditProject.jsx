      ...
      <div className="w-full max-w-md relative z-10 py-10">
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" style={{color:'#06b6d4'}}>
        ...
        <div className="rounded-3xl p-8 border border-white/10 backdrop-blur-md"
          ...
          <div className="mt-6 pt-6 border-t border-white/10 space-y-3">
            <p className="text-xs text-gray-600 uppercase tracking-wider">Danger Zone</p>
            ...
            {!showDeleteConfirm ? (
              ...
              <div className="p-3 rounded-xl border border-red-500/30 bg-red-500/5">
                <p className="text-red-400 text-sm mb-3">This cannot be undone. Are you sure?</p>
