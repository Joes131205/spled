...
- **Institution**: Binus University (Multiple campuses: Kemanggisan, Alam Sutera, Bandung, Bekasi, Online)
- **Target Users**: Undergraduate and graduate students
- **Use Case**: Group project management across semesters
- **Instructor Integration**: Transparent grading support

---

## ✅ Success Criteria

1. ✓ Fair task distribution with measurable metrics
2. ✓ Complete contribution transparency
3. ✓ Reduced free-rider occurrences by 80%+
4. ✓ Objective lecturer evaluation support
5. ✓ 90%+ user adoption rate among target groups
6. ✓ Sub-2-second dashboard load time
7. ✓ Seamless asynchronous collaboration support
...
│   │   ├── evidence-service/      # Evidence verification
│   │   └── ghost-buster-service/  # Notification system
│   ├── libs/common/               # Shared database utilities
...
- Auth Service: See `/server/app/auth-service/README.md`
- Project Service: See `/server/app/project-service/README.md`
- Evidence Service: See `/server/app/evidence-service/README.md`
- Ghost Buster Service: See `/server/app/ghost-buster-service/README.md`
